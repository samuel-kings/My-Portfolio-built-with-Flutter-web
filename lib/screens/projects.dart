  ...
  Widget projectCards() {
    ...
    return GridView.count(
      ...
      children: [
        ...
        ], 'Bezalio Hub', 'Bezalio Hub is a market place for products and home services with their primary market being the American and European States.', 'https://bezaliohub.com/'),
        _buildProjectsCards([
          'assets/borku/1.JPG',
          'assets/borku/2.jfif',
          'assets/borku/3.jfif',
          ...
          'assets/borku/7.jfif',
          'assets/borku/8.jfif',
        ], 'Borku Africa', 'Borku Africa is an online marketplace for where all Africans in diaspora can buy and sell African products and services., ', 'https://borkuafrica.com/'),
        _buildProjectsCards([
        ...
        ], 'Inaspace Design', '''Iná Space Design is an Interior Design firm in Lagos, Nigeria. We design and deliver high-end, exquisite interiors designs for our clients for their residences, offices, events, etc to suit lifestyle as well as other purposes.
We are also open for consultation, whereby we help you plan and make designs that are most suitable for your business and homes, thus facilitating comfort and customer attraction as the case may be.''', 'https://inaspacedesign.com/'), 
        _buildProjectsCards([
        ...
        ], 'Petonyx Educational Consult', '''Petonyx Educational Consult is an Organization established in 2018 with a mission to deliver exceptional International educational consulting services to students, parents and secondary schools.

We do this by giving a unique yet simple curriculum and modules of each examination, detailed explanation of each module and guide to passing examination , we teach using a comprehensive mark guide of each examination to ensure students pass their examination in just one sitting.''', 'https://petonyx.com/'),
        _buildProjectsCards([
          'assets/rightdeal/1.JPG',
          'assets/rightdeal/2.JPG',
          'assets/rightdeal/3.JPG',
          'assets/rightdeal/4.JPG',
        ], 'RightDeal Consulting', 'RightDeal Consulting Limited is a firm that provides lots of services to see that small to large businesses grow and increase revenue. To this effect, we offer a wide range of services such as Business consulting, increasing customer base, brand and services promotion, market research, job recruiting, just to mention a few.', ''),
      ],
    );
  }
                    ...
                    children: [
                      Container(
                        margin: EdgeInsets.only(
                            top: _isMobile ? 25 : 0, right: _isMobile ? 25 : 0),
                        alignment: Alignment.topRight,
                        child: InkWell(
                          onTap: () {
                            setState(() {
           ...
           child: HoverAnimatedContainer(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children:  const [
                        Icon(Icons.web, color: Colors.white, size: 25),
                        SizedBox(width: 10,),
                        Text(
                          'Visit site',
                          style: TextStyle(
